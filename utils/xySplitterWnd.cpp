...
void CxSplitterWnd::RecalcLayout(void)
{
    ...
    m_Parent->Invalidate(FALSE);//2007-04-05
}
...
BOOL CxSplitterWnd::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext)
{
...
void CxSplitterWnd::OnPaint()
{
    ...
    CBrush brush;
	GetClientRect(&rc);
	brush.CreateSolidBrush(RGB(212,209,204));
